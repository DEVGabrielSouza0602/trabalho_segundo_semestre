                ...
                # TABELA NUTRICIONAL
                    ...
                    while permanecer_tabela:
                        ...
                        if escolha_menu == 0:
                            ...
                            for i in range(config.size(config.alimento)):
                            ...
                            if escolha_alimento in range(config.size(config.alimento)):
                                os.system("cls")
                                time.sleep(1)
                                print(70*"=")  # Cabeçario da Tabela
                                print("                TABELA NUTRICIONAL")
                                print(70*"-")
                                # Mostra quantidade da consulta
                                print(
                                    f"Em {config.quantidade_teste[escolha_alimento]}g de {config.alimento[escolha_alimento]}:")
                                print(70*"-")
                                # Mostra calorias da consulta
                                print(
                                    f"Valor energético: {config.valor_energético[escolha_alimento]}kcal")
                                # Mostra carbboidratos da consulta
                                print(
                                    f"Carboidratos: {config.carboidratos[escolha_alimento]}g")
                                # Mostra proteinas da culta
                                print(
                                    f"Proteinas: {config.proteinas[escolha_alimento]}g")
                                # Mostra sodio da consulta
                                print(
                                    f"Sódio: {config.sodio[escolha_alimento]}mg")
                                print(70*"=")
                            ...
                            time.sleep(0.5)
                            print(70*"-")
                            # INPUT para quantidade de consulta
                            quantidade_nova = int(
                                input("Digite a quantidade analisada (em gramas): "))
                            time.sleep(0.5)
                            print(70*"-")
                            # INPUT para calorias
                            valor_novo = float(
                                input("Digite o valor energético (em kcal): "))
                            time.sleep(0.5)
                            print(70*"-")
                            carboidratos_novo = float(input(
                                "Digite a quantidade de carboidratos (em gramas): "))  # INPUT para carboidratos
                            time.sleep(0.5)
                            print(70*"-")
                            # INPUT para proteina
                            proteina_nova = float(
                                input("Digite o quantidade de proteina (em gramas): "))
                            time.sleep(0.5)
                            print(70*"-")
                            # INPUT para sodio
                            sodio_novo = float(
                                input("Digite o quantidade de sódio (em gramas): "))
                            time.sleep(1)
                            print(70*"=")
                            ...
                            adicionar = input("Confirmar a adição: Sim ou Não? ").lower().startswith(
                                's')  # Confirmação antes de adicionar o alimento
                            if adicionar == True:  # IF para adicionar os dados do novo alimento, e retornar ao inicio da tabela
                                ...
                                config.push(config.quantidade_teste,
                                            quantidade_nova)
                                config.push(
                                    config.valor_energético, valor_novo)
                                config.push(config.carboidratos,
                                            carboidratos_novo)
